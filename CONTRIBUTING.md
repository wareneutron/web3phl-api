# 🎯 Web3 Philippines Directory API
...
This project and everyone participating in it is governed by the COVID-19 Tracker & CLI [Code of Conduct](https://github.com/wareneutron/web3phl-api/blob/main/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to <opensource@wareneutron.com>.
...
Answering a question in [Discussions](https://github.com/wareneutron/web3phl-api/discussions) is one of the easiest ways to start contributing.
